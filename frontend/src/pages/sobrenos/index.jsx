            ...
            <div className="sobre">
                ...
                <div className="fale">
                    ...
                    <div className="comments-txt">
                        <h3 className="pe">
                            Acreditamos que cada pessoa é única e merece
                            produtos que se alinhem com sua individualidade e
                            valores. Por isso, trabalhamos para oferecer
                            soluções eficazes que promovam sua beleza natural e
